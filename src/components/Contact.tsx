...
const Contact = () => {
  return (
    <section id="contact" className="px-6 md:px-16 lg:px-24 max-w-4xl mx-auto py-20 pb-32">
      <div className="relative overflow-hidden rounded-[32px] border border-border/60 bg-gradient-to-br from-background/70 via-background/30 to-background/70 p-10 md:p-14 shadow-[0_20px_45px_rgba(0,0,0,0.35)]">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-serif italic text-foreground leading-tight">Let's build something together</h2>
          </div>
